...
@pytest.mark.parametrize(
    ...
    [
        (1.0, 2.0, 3, 2.0, 6.0, 6.0e-9),
        (0.5, 4.0, 2, 4.0, 8.0, 8.0e-9),
        (2.0, 1.5, 4, 2.25, 9.0, 9.0e-9),
...
def test_tf_stored_magnetic_energy(
    ...
    assert pytest.approx(result[0]) == expected_single
    assert pytest.approx(result[1]) == expected_total
    assert pytest.approx(result[2]) == expected_total_gj
