...
@pytest.mark.parametrize(
    ...
    (
        DcllMassesParam(
            ...
            expected_fw_armour_vol=14.032719775669307,
            expected_fw_armour_mass=270129.85568163416,
            expected_volfw=28.820872142117942,
            expected_armour_fw_bl_mass=11117992.32941449,
            ...
            expected_mass_segm_ib=97092.03502767911,
            expected_mass_segm_ob=160054.77328207614,
        ),
        DcllMassesParam(
            ...
            fw_armour_vol=14.032719775669307,
            fw_armour_thicknessi=0.0050000000000000001,
            fw_armour_thicknesso=0.0050000000000000001,
            fw_armour_mass=270129.85568163416,
            ...
            mass_segm_ib=97092.03502767911,
            ...
            expected_armour_fw_bl_mass=11172360.109563196,
            expected_r_f_liq_ib=0.79000002145767212,
            expected_w_f_liq_ib=0.79000002145767212,
            expected_w_f_liq_ob=0.79000002145767212,
            ...
            expected_mass_segm_ib=97116.29560922067,
            expected_mass_segm_ob=160441.36142180217,
        ),
    ),
)
def test_dcll_masses(dcllmassesparam, monkeypatch, dcll):
    ...
    monkeypatch.setattr(
        fwbs_variables, "fw_armour_thicknessi", dcllmassesparam.fw_armour_thicknessi
    )

    monkeypatch.setattr(
        fwbs_variables, "fw_armour_thicknesso", dcllmassesparam.fw_armour_thicknesso
    )
