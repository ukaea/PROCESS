...
def test_dcll_neutronics_and_power(dcllneutronicsandpowerparam, monkeypatch, dcll):
    ...
    monkeypatch.setattr(
        build_variables,
        "fwareaob",
        dcllneutronicsandpowerparam.fwareaob,
    )
    ...
    monkeypatch.setattr(
        fwbs_variables,
        "pnucshld",
        dcllneutronicsandpowerparam.pnucshld,
    )
    ...
    monkeypatch.setattr(
        fwbs_variables,
        "psurffwi",
        dcllneutronicsandpowerparam.psurffwi,
    )

    monkeypatch.setattr(
        fwbs_variables,
        "psurffwo",
        dcllneutronicsandpowerparam.psurffwo,
    )

    monkeypatch.setattr(
        fwbs_variables,
        "pnucblkt",
        dcllneutronicsandpowerparam.pnucblkt,
    )
    ...
    monkeypatch.setattr(
        physics_variables,
        "palpfwmw",
        dcllneutronicsandpowerparam.palpfwmw,
    )
...
def test_dcll_masses(dcllmassesparam, monkeypatch, dcll):
    ...
    monkeypatch.setattr(
        fwbs_variables,
        "fw_armour_thickness",
        dcllmassesparam.fw_armour_thickness,
    )

    monkeypatch.setattr(
        fwbs_variables,
        "fw_armour_mass",
        dcllmassesparam.fw_armour_mass,
    )
    ...
    monkeypatch.setattr(
        fwbs_variables,
        "armour_fw_bl_mass",
        dcllmassesparam.armour_fw_bl_mass,
    )
    ...
    monkeypatch.setattr(
        fwbs_variables,
        "th_wall_secondary",
        dcllmassesparam.th_wall_secondary,
    )
    ...
    monkeypatch.setattr(
        dcll_module,
        "f_vol_stff_plates",
        dcllmassesparam.f_vol_stff_plates,
    )

    monkeypatch.setattr(
        dcll_module,
        "f_vol_stl_bz_struct",
        dcllmassesparam.f_vol_stl_bz_struct,
    )

    monkeypatch.setattr(
        dcll_module,
        "f_vol_stl_back_wall",
        dcllmassesparam.f_vol_stl_back_wall,
    )
    ...
    monkeypatch.setattr(
        dcll_module,
        "f_vol_mfbss_pbli",
        dcllmassesparam.f_vol_mfbss_pbli,
    )
    ...
    monkeypatch.setattr(
        dcll_module,
        "mass_cool_blanket",
        dcllmassesparam.mass_cool_blanket,
    )

    monkeypatch.setattr(
        dcll_module,
        "mass_liq_blanket",
        dcllmassesparam.mass_liq_blanket,
    )

    monkeypatch.setattr(
        dcll_module,
        "mass_stl_blanket",
        dcllmassesparam.mass_stl_blanket,
    )
