...
class BldgsParam(NamedTuple):
    ...
    clh2: Any
    dz_tf_cryostat: Any
    dz_plant_reactor_building_crane_roof_clearance: Any
    rbvfac: Any
    ...
    vol_plant_shops_warehouse_buildings: Any
    shovol: Any
    convol: Any
    vol_plant_nuclear_buildings: Any
    iprint: Any
...
@pytest.mark.parametrize(
    ...
    (
        BldgsParam(
            ...
            dz_plant_reactor_building_crane_roof_clearance=3,
            ...
            vol_plant_shops_warehouse_buildings=100000,
            shovol=0,
            convol=0,
            vol_plant_nuclear_buildings=0,
            iprint=0,
...
def test_bldgs(buildings, bldgsparam, monkeypatch):
    ...
    monkeypatch.setattr(
        ...
        bldgsparam.dz_plant_reactor_building_crane_roof_clearance,
    )
    ...
    monkeypatch.setattr(
        ...
        bldgsparam.vol_plant_administration_building,
    )
    monkeypatch.setattr(
        buildings_variables,
        "vol_plant_shops_warehouse_buildings",
        bldgsparam.vol_plant_shops_warehouse_buildings,
    )
