...
@pytest.mark.parametrize(
    ...
    [
        PlasmaCompositionParam(
            ...
            expected_nd_fuel_ions=5.858890125e+19,
            expected_m_ions_total_amu=2.7395439636787726,
            expected_nd_ions_total=6.612527625000001e+19,
        ...
        PlasmaCompositionParam(
            ...
            expected_m_fuel_amu=2.5145269632339478,
            expected_nd_fuel_ions=5.857588175158546e+19,
...
@pytest.mark.parametrize(
    ...
    [
        PhyauxParam(
            ...
            burnup_in=0,
            aspect=3,
            nd_plasma_fuel_ions_vol_avg=5.858890125e+19,
            nd_plasma_alphas_thermal_vol_avg=7.5e18,
            ...
            expected_molflow_plasma_fuelling_required=1.838944781084418e+21,
