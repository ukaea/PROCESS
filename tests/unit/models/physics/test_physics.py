...
@pytest.mark.parametrize(
    ...
    [
        BootstrapFractionNevinsParam(
            ...
            zeff=2.0913454745,
            expected_fibs=889246320135.0845,
        ),
    ],
)
...
class BootstrapFractionSauterParam(NamedTuple):
    ...
    n_charge_plasma_effective_vol_avg: Any = None
    ...
    temp_plasma_pedestal_electron_kev: Any = None
...
@pytest.mark.parametrize(
    ...
    [
        BootstrapFractionSugiyamaHModeParam(
            ...
            n_greenwald=8.0e19,
            temp_plasma_pedestal_electron_kev=5.0,
        ...
        BootstrapFractionSugiyamaHModeParam(
            ...
            n_greenwald=7.5e19,
            temp_plasma_pedestal_electron_kev=4.5,
        ...
        BootstrapFractionSugiyamaHModeParam(
            ...
            n_greenwald=1e20,
            temp_plasma_pedestal_electron_kev=6.0,
...
def test_bootstrap_fraction_sugiyama_h_mode(bootstrapfractionsugiyamahparam, physics):
    ...
    bfs = physics.plasma_bootstrap_current.bootstrap_fraction_sugiyama_h_mode(
        ...
        temp_plasma_pedestal_electron_kev=bootstrapfractionsugiyamahparam.temp_plasma_pedestal_electron_kev,
    )
...
@pytest.mark.parametrize(
    ...
    [
        PlasmaCompositionParam(
            ...
            expected_nd_fuel_ions=5.858890125e19,
            expected_m_ions_total_amu=2.7395439636787726,
            expected_nd_ions_total=6.612527625000001e19,
            expected_zeffai=0.4304676079821312,
            expected_f_alpha_ion=0.3154069116809366,
            expected_dlamee=17.510652035055571,
            expected_zeff=2.0913454745,
        ...
        PlasmaCompositionParam(
            ...
            expected_m_fuel_amu=2.5145269632339478,
            expected_nd_fuel_ions=5.857588175158546e19,
            expected_m_ions_total_amu=2.7392489422048745,
            expected_nd_ions_total=6.612527625000001e19,
            expected_zeffai=0.43056805756193167,
...
def test_plasma_composition(plasmacompositionparam, monkeypatch, physics):
    ...
    for field in [
        ...
        monkeypatch.setattr(
            ...
            field,
            getattr(plasmacompositionparam, field),
        )
    ...
    for field in [
        ...
        monkeypatch.setattr(
            physics.data.physics, field, getattr(plasmacompositionparam, field)
        )
...
@pytest.mark.parametrize(
    ...
    [
        PohmParam(
            ...
            vol_plasma=1888.1711539956691,
            zeff=2.0913454745,
            expected_pden_plasma_ohmic_mw=0.00040632009141325685,
            expected_p_plasma_ohmic_mw=0.7672018758953949,
