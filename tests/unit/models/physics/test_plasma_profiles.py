...
class TeProfileParam(NamedTuple):
    ...
    tbeta: float = 0.0
    temp_plasma_separatrix_electron_kev: float = 0.0
    i_plasma_pedestal: float = 0.0
    alphat: float = 0.0
...
@pytest.mark.parametrize(
    ...
    [
        PlasmaProfilesParam(
            ...
            expected_ten=14.522347259658327,
            expected_tin=14.522347259658327,
            expected_alphap=2.4500000000000002,
            expected_te0=27.370104119511087,
            expected_p0=868106.0658743214,
            expected_pcoef=1.111120677862152,
...
def test_plasma_profiles(plasmaprofilesparam, monkeypatch, plasmaprofile):
    ...
    monkeypatch.setattr(
        ...
        plasmaprofilesparam.temp_plasma_separatrix_electron_kev,
    )
