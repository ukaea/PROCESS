...
class CalcBuildingCostsParam:
    ...
    s_cref: np.ndarray
    s_cost: np.ndarray
    s_cost_factor: np.ndarray
    expected_s_kref: np.ndarray
    expected_s_k: np.ndarray
    expected_s_cref: np.ndarray
    expected_s_cost: np.ndarray
    expected_s_cost_factor: np.ndarray
...
@pytest.mark.parametrize(
    ...
    [
        CalcBuildingCostsParam(
            ...
            expected_s_cost_factor=np.array([*np.ones(9), *np.zeros(91)]),
        ),
        CalcBuildingCostsParam(
            pwpnb=109.38112972595434,
            ...
            s_cost_factor=np.array(
                [*np.ones(20), 0, *np.ones(39), *np.zeros(40)],
            ),
            expected_s_kref=np.array(
                [
                    0,
...
@pytest.mark.parametrize(
    ...
    [
        CalcLandCostsParam(
            ...
            s_cost_factor=np.array([*np.ones(9), *np.zeros(91)]),
            expected_s_kref=np.array([
                0,
                18712,
                120,
            ...
            expected_s_cost_factor=np.array([*np.ones(13), *np.zeros(87)]),
        ),
        CalcLandCostsParam(
...
@pytest.mark.parametrize(
    ...
    [
        CalcTfCoilCostsParam(
            ...
            s_cost_factor=np.array([*np.ones(13), *np.zeros(87)]),
            expected_s_kref=np.array([
                0,
                18712,
                120,
...
@pytest.mark.parametrize(
    ...
    [
        CalcRemoteHandlingCostsParam(
            ...
            s_cost_factor=np.array(
                [*np.ones(20), 0, *np.ones(6), *np.zeros(73)],
            ),
            expected_s_kref=np.array([
                0,
                18712,
            ...
            expected_s_cost_factor=np.array(
                [*np.ones(20), 0, *np.ones(10), *np.zeros(69)],
            ),
        ),
        CalcRemoteHandlingCostsParam(
...
@pytest.mark.parametrize(
    ...
    [
        CalcNPlantAndVvCostsParam(
            ...
            expected_s_cost_factor=np.array(
                [*np.ones(20), 0, *np.ones(13), *np.zeros(66)],
            ),
        ),
        CalcNPlantAndVvCostsParam(
...
@pytest.mark.parametrize(
    ...
    [
        CalcEnergyConversionSystemParam(
            ...
            expected_s_cost_factor=np.array(
                [*np.ones(20), 0, *np.ones(14), *np.zeros(65)],
            ),
        ),
        CalcEnergyConversionSystemParam(
