...
def test_init_neoclassics(initneoclassicsparam, monkeypatch, neoclassics):
    ...
    monkeypatch.setattr(
        physics_variables,
        "f_deuterium",
        initneoclassicsparam.f_deuterium,
    )
    ...
    monkeypatch.setattr(
        neoclassics_module,
        "temperatures",
        initneoclassicsparam.temperatures,
    )
    monkeypatch.setattr(
        neoclassics_module,
        "dr_densities",
        initneoclassicsparam.dr_densities,
    )
    monkeypatch.setattr(
        neoclassics_module,
        "dr_temperatures",
        initneoclassicsparam.dr_temperatures,
    )
    ...
    monkeypatch.setattr(
        neoclassics_module,
        "nu_star_averaged",
        initneoclassicsparam.nu_star_averaged,
    )
