...
def test_stbild(stbildparam, monkeypatch, stellarator):
    ...
    monkeypatch.setattr(build_variables, "dz_blkt_top", stbildparam.dz_blkt_top)
    ...
    assert build_variables.dz_blkt_top == pytest.approx(
        stbildparam.expected_dz_blkt_top
    )
