...
class DivgeomParam(NamedTuple):
    ...
    len_div_leg_inner_poloidal: Any = None

    len_div_inner_plate_poloidal: Any = None

    len_div_leg_outer_poloidal: Any = None

    rad_div_outer_leg_plate_poloidal: Any = None
...
@pytest.mark.parametrize(
    ...
    (
        DivgeomParam(
            ...
            rad_div_outer_leg_plate_poloidal=1,
...
def test_divgeom(divgeomparam, monkeypatch, build):
    ...
    monkeypatch.setattr(
        ...
        divgeomparam.len_div_leg_inner_poloidal,
    )

    monkeypatch.setattr(
        build_variables,
        "len_div_inner_plate_poloidal",
        divgeomparam.len_div_inner_plate_poloidal,
    )
    ...
    monkeypatch.setattr(
        ...
        divgeomparam.rad_div_outer_leg_plate_poloidal,
    )
