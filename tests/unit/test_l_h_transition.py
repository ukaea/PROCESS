...
def test_calculate_iter1996_nominal(a, b, c, expected):
    assert physics.transition.calculate_iter1996_nominal(a, b, c) == pytest.approx(
        expected
    )
...
def test_calculate_iter1996_upper(a, b, c, expected):
    assert physics.transition.calculate_iter1996_upper(a, b, c) == pytest.approx(
        expected
    )
...
def test_calculate_iter1996_lower(a, b, c, expected):
    assert physics.transition.calculate_iter1996_lower(a, b, c) == pytest.approx(
        expected
    )
...
def test_calculate_snipes1997_iter(a, b, c, expected):
    assert physics.transition.calculate_snipes1997_iter(a, b, c) == pytest.approx(
        expected
    )
...
def test_calculate_snipes1997_kappa(a, b, c, d, expected):
    assert physics.transition.calculate_snipes1997_kappa(a, b, c, d) == pytest.approx(
        expected
    )
...
def test_calculate_martin08_nominal(a, b, c, d, expected):
    assert physics.transition.calculate_martin08_nominal(a, b, c, d) == pytest.approx(
        expected
    )
...
def test_calculate_martin08_upper(a, b, c, d, expected):
    assert physics.transition.calculate_martin08_upper(a, b, c, d) == pytest.approx(
        expected
    )
...
def test_calculate_martin08_lower(a, b, c, d, expected):
    assert physics.transition.calculate_martin08_lower(a, b, c, d) == pytest.approx(
        expected
    )
...
def test_calculate_snipes2000_nominal(a, b, c, d, e, expected):
    assert physics.transition.calculate_snipes2000_nominal(
        a, b, c, d, e
...
def test_calculate_snipes2000_upper(a, b, c, d, e, expected):
    assert physics.transition.calculate_snipes2000_upper(a, b, c, d, e) == pytest.approx(
        expected
    )
...
def test_calculate_snipes2000_lower(a, b, c, d, e, expected):
    assert physics.transition.calculate_snipes2000_lower(a, b, c, d, e) == pytest.approx(
        expected
    )
...
def test_calculate_snipes2000_closed_divertor_nominal(a, b, c, d, expected):
    assert physics.transition.calculate_snipes2000_closed_divertor_nominal(
        a, b, c, d
    ) == pytest.approx(expected)
...
def test_calculate_snipes2000_closed_divertor_upper(a, b, c, d, expected):
    assert physics.transition.calculate_snipes2000_closed_divertor_upper(
        a, b, c, d
    ) == pytest.approx(expected)
...
def test_calculate_snipes2000_closed_divertor_lower(a, b, c, d, expected):
    assert physics.transition.calculate_snipes2000_closed_divertor_lower(
        a, b, c, d
    ) == pytest.approx(expected)
...
def test_calculate_hubbard2012_nominal(a, b, expected):
    assert physics.transition.calculate_hubbard2012_nominal(a, b) == pytest.approx(
        expected
    )
...
def test_calculate_hubbard2012_upper(a, b, expected):
    assert physics.transition.calculate_hubbard2012_upper(a, b) == pytest.approx(
        expected
    )
...
def test_calculate_hubbard2012_lower(a, b, expected):
    assert physics.transition.calculate_hubbard2012_lower(a, b) == pytest.approx(
        expected
    )
...
def test_calculate_hubbard2017(a, b, c, expected):
    assert physics.transition.calculate_hubbard2017(a, b, c) == pytest.approx(expected)
...
def test_calculate_martin08_aspect_nominal(a, b, c, d, e, expected):
    assert physics.transition.calculate_martin08_aspect_nominal(
        a, b, c, d, e
    ) == pytest.approx(expected)
...
def test_calculate_martin08_aspect_upper(a, b, c, d, e, expected):
    assert physics.transition.calculate_martin08_aspect_upper(
        a, b, c, d, e
    ) == pytest.approx(expected)
...
def test_calculate_martin08_aspect_lower(a, b, c, d, e, expected):
    assert physics.transition.calculate_martin08_aspect_lower(
        a, b, c, d, e
    ) == pytest.approx(expected)
