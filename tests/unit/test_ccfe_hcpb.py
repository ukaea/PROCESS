...
def test_nuclear_heating_magnets(nuclearheatingmagnetsparam, monkeypatch, ccfe_hcpb):
    ...
    monkeypatch.setattr(
        fwbs_variables, "pitch_outboard", nuclearheatingmagnetsparam.pitch_outboard
    )
    ...
    monkeypatch.setattr(
        ...
        nuclearheatingmagnetsparam.fw_armour_thickness_outboard,
    )
...
@pytest.mark.parametrize(
    ...
    (
        TbrShimwellParam(
            ...
            fw_armour_thickness_outboard=0.0030000000000000001,
            ip=0,
            iprint=0,
            outfile=11,
...
def test_tbr_shimwell(tbrshimwellparam, monkeypatch, ccfe_hcpb):
    ...
    monkeypatch.setattr(
        fwbs_variables,
        "fw_armour_thickness_outboard",
        tbrshimwellparam.fw_armour_thickness_outboard,
    )
