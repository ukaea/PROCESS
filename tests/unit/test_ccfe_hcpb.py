...
@pytest.mark.parametrize(
    ...
    (
        NuclearHeatingMagnetsParam(
            ...
            pitch=0.02, #
            denstl=7800,
            whtblkt=2967600.0000000000, # 2.9676E+06
            volblkt=1184.900112000000, # 1184.900112
            whtshld=2449800.000000000, # 2.4498E+06
            volshld=785.2000000000000, # 7.8520E+02
            vvmass=7938800.0000000000,  # 7.9388E+06
            vdewin=1017.8000000000000, # 1.0178E+03
            ...
            vffwi=0,
            vffwo=0,
            powfmw=1663.1000000000000, # 1.6631E+03
            itart=0,
            whttf=10065000.000000000, # 1.0065E+07
            whttflgs=0,
            verbose=0,
            ip=0,
            ofile=11,
