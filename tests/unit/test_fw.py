...
class FwTempParam(NamedTuple):
    ...
    fw_channel_length_outboard: Any = None

    tpeak: Any = None

    peaking_factor_outboard: Any = None
...
@pytest.mark.parametrize(
    ...
    (
        FwTempParam(
            ...
            fw_channel_length_outboard=4,
            tpeak=873,
            peaking_factor_outboard=1,
...
def test_fw_temp(fwtempparam, monkeypatch, fw):
    ...
    monkeypatch.setattr(
        ...
        fwtempparam.fw_channel_length_outboard,
    )

    monkeypatch.setattr(fwbs_variables, "tpeak", fwtempparam.tpeak)

    monkeypatch.setattr(
        fwbs_variables, "peaking_factor_outboard", fwtempparam.peaking_factor_outboard
    )
    ...
    tpeakfw, cfmean, rhofmean, massrate = fw.fw_temp(
        ...
        afw_outboard=fwtempparam.afw_outboard,
