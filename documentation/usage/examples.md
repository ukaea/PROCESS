...
The Binder may take some time to load, but once loaded you can click on the `File Browser` tab down the left hand side,
which takes you to the `examples` folder. Here, you can select example notebooks to run in your web browser.
