...
<script type="text/javascript">
    ...
    const fn = function() {
        ...
        (function(root) {
            ...
            const docs_json = document.getElementById('b3078935-3109-4221-a8a2-f83d7e19ea16').textContent;
            const render_items = [{"docid":"46ec3fcd-a746-4c93-8b7a-631a7158035e","roots":{"p1087":"f313da41-e7c2-468c-add4-d180c877b452"},"root_ids":["p1087"]}];
