...
AUXILIARY POWER LOWER LIMIT FOR CONSTRAINT 40 WITH `auxmin`
injected upper limit with icc=30 and `pinjalw`
secondary fixed heating with `pheatfix` and `pinjfixmw`
