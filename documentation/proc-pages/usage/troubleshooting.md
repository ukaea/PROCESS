...
file and, for serious logs, the terminal. The logs that occur on the final iteration (or during an evaluation)
are written out to the terminal and to the OUT.DAT file.
