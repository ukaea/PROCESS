...
The water evaporated can be estimated from the waste heat remaining after electricity generation: equal to the high-grade heat useful for electricity production (`p_thermal_primary_mw`) minus the gross electricity produced (`p_gross_electrical`).  
