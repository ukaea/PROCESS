...
$$
1.0 = [\underbrace{\underbrace{I_{\text{F,Boot}} + I_{\text{F,Dia}} + I_{\text{F,PS}}}_{\text{Generated by plasma}} + I_{\text{F,CD}}}_{\text{Non-inductive}}] + \underbrace{I_{\text{F,CS}}}_{\text{Inductive}}
$$
