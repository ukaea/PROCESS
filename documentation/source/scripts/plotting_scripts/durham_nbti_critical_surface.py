...
b_conductor = np.linspace(2, 12.0, 50)  # Magnetic field range (T)
...
ax.set_title("Durham NbTi Critical Current Density Surface at Zero Strain")
ax.view_init(elev=30, azim=45)  # Rotate the plot around the z-axis by 45 degrees
fig.colorbar(surf, shrink=0.5, aspect=10)

# Save the plot as a PNG file
plt.savefig("Durham_NbTi_zero_strain.png", dpi=1000)
...
fig_plotly.update_layout(
    title="Durham NbTi Critical Current Density Surface at Zero Strain",
    scene={
...
fig_plotly.write_html("Durham NbTi_zero_strain.html")
