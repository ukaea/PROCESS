...
1. **Alpha Ash Portion Calculation**
    ...
    - Calculate the number density of thermal alpha particles (`nd_plasma_alphas_thermal_vol_avg`) using the electron density (`nd_plasma_electrons_vol_avg`) and the alpha particle to electron ratio (`f_nd_alpha_electron`).
