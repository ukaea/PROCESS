...
10. **Set Impurity Fraction Variables**
    ...
    $$
    \mathtt{f_nd_plasma_carbon_electron} = \frac{n_{\text{C}}}{n_{\text{e}}}, \quad \mathtt{f_nd_plasma_oxygen_electron} = \frac{n_{\text{O}}}{n_{\text{e}}} \quad \mathtt{rnfene} = \frac{n_{\text{Fe}}+ n_{\text{Ar}}}{n_{\text{e}}}
    $$
