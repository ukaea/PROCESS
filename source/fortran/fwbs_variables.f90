module fwbs_variables
  ...
  integer :: n_blkt_inboard_module_coolant_sections_radial, n_blkt_inboard_module_coolant_sections_poloidal, n_blkt_outboard_module_coolant_sections_radial, bzfllengo_n_pol
