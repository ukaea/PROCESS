...
20     continue
      ...
      case ('dhecoil')
       ...
       case ('pres_fw')
          call parse_real_variable('pres_fw', pres_fw, 1.0d5, 1.0D8, &
      ...
      case ('i_blkt_coolant')
         call parse_int_variable('i_blkt_coolant', i_blkt_coolant, 1, 2, &
      ...
      case ('secondary_cycle_liq')
       ...
       case ('temp_blkt_in')
          call parse_real_variable('temp_blkt_in', temp_blkt_in, 200.0D0, 600.0D0, &
