...
contains
  ...
  subroutine parse_input_file(in_file,out_file,show_changes)
    ...
    use fwbs_variables, only: fblhebpo, vfblkt, fdiv, fvolso, fwcoolant_outboard, &
      ...
      fw_armour_thickness_outboard, roughness_outboard, fwclfr, breedmat, fblli, fblvd, &
      ...
      npdiv, peaking_factor_outboard, primary_pumping, rpf2dewar, secondary_cycle, secondary_cycle_liq, &
...
20     continue
      ...
      !          'Switch for TF coil model')
       ...
       case ('fwinlet_outboard')
          call parse_real_variable('fwinlet_outboard', fwinlet_outboard, 300.0d0, 1500.0D0, &
               'inlet temperature of first wall coolant (K)')
       case ('fwoutlet_outboard')
          call parse_real_variable('fwoutlet_outboard', fwoutlet_outboard, 300.0d0, 1500.0D0, &
               'outlet temperature of first wall coolant (K)')
       case ('fwpressure_outboard')
          call parse_real_variable('fwpressure_outboard', fwpressure_outboard, 1.0d5, 1.0D8, &
       ...
       case ('peaking_factor_outboard')
          call parse_real_variable('peaking_factor_outboard', peaking_factor_outboard, 1.0d0, 100.0D0, &
      ...
      case ('secondary_cycle_liq')
       ...
       case ('fw_armour_thickness_outboard')
          call parse_real_variable('fw_armour_thickness_outboard', fw_armour_thickness_outboard, 0.0D0, 1.0D0, &
       ...
       case ('iblanket')
          ...
          if (iblanket == 3) then
              fwith = 0.03D0
              fwoth = 0.03D0
              fw_armour_thickness_outboard = 0.003D0
          end if
       case ('iblnkith')
