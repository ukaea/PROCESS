...
contains
   ...
   subroutine constraint_eqn_087(tmp_cc, tmp_con, tmp_err, tmp_symbol, tmp_units)
      ...
      !! fp_cryo_plant_electric_max_mw : input real : f-value for maximum cryogenic plant power
      !! p_cryo_plant_electric_max_mw : input real : Maximum cryogenic plant power (MW)

      use heat_transport_variables, only: p_cryo_plant_electric_mw, p_cryo_plant_electric_max_mw, fp_cryo_plant_electric_max_mw
      implicit none
            real(dp), intent(out) :: tmp_cc
      real(dp), intent(out) :: tmp_con
      real(dp), intent(out) :: tmp_err
      ...
      tmp_cc =  1.0D0 - fp_cryo_plant_electric_max_mw * p_cryo_plant_electric_max_mw/p_cryo_plant_electric_mw
