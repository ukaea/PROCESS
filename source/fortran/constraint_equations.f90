...
contains
   ...
   subroutine constraint_eqn_012(tmp_cc, tmp_con, tmp_err, tmp_symbol, tmp_units)
      ...
      !! vsstt (lower limit) is positive; vs_cs_pf_total_pulse (available) is negative
      ...
      tmp_cc =  1.0D0 + fvs * vs_cs_pf_total_pulse/vsstt
   ...
   subroutine constraint_eqn_051(tmp_cc, tmp_con, tmp_err, tmp_symbol, tmp_units)
      ...
      tmp_cc =  1.0D0 - fvssu * abs((vsres+vsind) / vs_cs_pf_total_ramp)
