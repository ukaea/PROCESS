module build_variables
  ...
  !#TODO: Issue #514 Make dr_tf_coil_inboard an output not an iteration variable
  real(dp) :: dr_tf_coil_inboard
  ...
  subroutine init_build_variables
    ...
    shldtth = 0.6D0
    sigallpc = 3.0D8
    dr_tf_coil_inboard = 0.0D0
    tfoffset = 0.0D0
    tfootfi = 1.19D0
    dr_tf_coil_outboard = 0.0D0
    tftsgap = 0.05D0
    thshield_ib = 0.05D0
    thshield_ob = 0.05D0
    thshield_vb = 0.05D0
