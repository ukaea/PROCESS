module current_drive_variables
  ...
  subroutine init_current_drive_variables
    ...
    beamwd = 0.58D0
    bigq = 0.0D0
    f_c_plasma_bootstrap = 0.0D0
    f_c_plasma_bootstrap_max = 0.9D0
    f_c_plasma_bootstrap_iter89 = 0.0D0
    f_c_plasma_bootstrap_nevins = 0.0D0
    f_c_plasma_bootstrap_sauter = 0.0D0
    f_c_plasma_bootstrap_wilson = 0.0D0
    f_c_plasma_bootstrap_sakai = 0.0D0
    f_c_plasma_bootstrap_aries = 0.0D0
    f_c_plasma_bootstrap_andrade = 0.0D0
    f_c_plasma_bootstrap_hoang = 0.0D0
    f_c_plasma_bootstrap_wong = 0.0D0
    bscf_gi_I = 0.0D0
    bscf_gi_II = 0.0D0
    cboot = 1.0D0
    c_beam_total = 0.0D0
    ...
    eta_hcd_secondary_injector_wall_plug = 0.0D0
    ...
    f_c_plasma_internal = 0.0D0
    plhybd = 0.0D0
    pnbeam = 0.0D0
    p_beam_orbit_loss_mw = 0.0D0
    f_c_plasma_pfirsch_schluter = 0.0D0
    pwplh = 0.0D0
    pwpnb = 0.0D0
    rtanbeam = 0.0D0
    rtanmax = 0.0D0
    n_beam_decay_lengths_core = 0.0D0
    tbeamin = 3.0D0
