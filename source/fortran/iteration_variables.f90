...
contains
  ...
  subroutine init_itv_164
    ...
    use numerics, only: lablxc, boundl, boundu
    implicit none
    lablxc(164) = 'fp_cryo_plant_electric_max_mw         '
    boundl(164) = 0.001D0
    boundu(164) = 1.000D0
  end subroutine init_itv_164

  real(kind(1.d0)) function itv_164()
    use heat_transport_variables, only: fp_cryo_plant_electric_max_mw
    implicit none
    itv_164 = fp_cryo_plant_electric_max_mw
  ...
  subroutine set_itv_164(ratio)
    ...
    implicit none
    real(kind(1.d0)) :: ratio
    fp_cryo_plant_electric_max_mw = ratio
