...
def plot_full_sankey(
    ...
    for _ in range(2):
        ...
        SHIELD = [pnucshld, p_shld_coolant_pump_mw, -p_shld_heat_deposited_mw]
        ...
        HEAT = [p_fw_heat_deposited_mw, p_blkt_heat_deposited_mw, p_shld_heat_deposited_mw, pthermdiv, -pthermmw]
