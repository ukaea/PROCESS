...
def plot_full_sankey(
    ...
    p_div_coolant_thermal_mw = m_file.data["p_div_coolant_thermal_mw"].get_scan(
        -1
...
def plot_sankey(mfilename="MFILE.DAT"):  # Plot simplified power flow Sankey Diagram
    ...
    # Used in [RECIRC]
    p_cryo_plant_mw = m_file.data["p_cryo_plant_mw"].get_scan(
        -1
    ...
    p_vacuum_pumps_mw = m_file.data["p_vacuum_pumps_mw"].get_scan(
        -1
