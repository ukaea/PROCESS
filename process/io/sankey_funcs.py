...
def plot_full_sankey(
    ...
    for _ in range(2):
        ...
        divertor = [pdivt, p_div_nuclear_heat_total_mw, praddiv, htpmw_div, -pthermdiv]
        sankey.add(
            flows=divertor,
        ...
        first_wall = [palpfwmw, p_fw_nuclear_heat_total_mw, p_fw_rad_total_mw, htpmwfw, -pthermfw]
        sankey.add(
            flows=first_wall,
...
def plot_sankey(mfilename="MFILE.DAT"):  # Plot simplified power flow Sankey Diagram
    ...
    totaldivetc = pdivt + p_div_nuclear_heat_total_mw + praddiv
