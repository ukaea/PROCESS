...
def main_plot(
    ...
    plot_7.set_position([0.175, 0.1, 0.3, 0.8])  # Move plot slightly to the right
    plot_iteration_variables(plot_7, m_file_data, scan)
    plot_7_5 = fig2.add_subplot(122)
    plot_7_5.set_position([0.65, 0.1, 0.3, 0.8])  # Move plot slightly to the right
    plot_constraint_equations(plot_7_5, m_file_data, scan)
