...
def main_plot(
    ...
    plot_plasma_outboard_toroidal_ripple_map(fig12, m_file_data, scan)
    ...
    plot_cs_coil_structure(
        fig17.add_subplot(121, aspect="equal"), fig17, m_file_data, scan
    )
    plot_cs_turn_structure(
        fig17.add_subplot(224, aspect="equal"), fig17, m_file_data, scan
    )
