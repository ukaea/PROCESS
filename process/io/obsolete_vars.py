...
Each key is an obsolete var, the value is a list with first entry being either the new var name or None if the
var is deprecated, and the second entry being an optional helpful message.
...
OBS_VARS = {
    ...
    "fradmin": [None],
    "ftr": ["ftrit"],
    "iculdl": ["idensl", "(use IDENSL=3 for equivalent model to ICULDL=0). "],
    "iiter": [None],
    "ires": [None],
    "fjtfc": [None],
    "bcylth": [None],
    ...
    "blnktth": [
        None,
        "WARNING. BLNKTTH is now always calculated rather than input - please remove it from the input file",
    ],
}
stellarator_list = [
    "target_spread",
...
stellarator_message = "The Stellarator model is currently not included in PROCESS. See issue #1854 for more information on the use of Stellarators. "
OBS_VARS.update(dict.fromkeys(stellarator_list, [None, stellarator_message]))
