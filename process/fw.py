...
class Fw:
    ...
    def fw_temp(
        ...
        ib_fluid_properties = FluidProperties.of(
            ...
            temperature=fwbs_variables.temp_fw_in.item(),
        ...
        ob_fluid_properties = FluidProperties.of(
            f2py_compatible_to_string(fwbs_variables.fwcoolant),
            temperature=fwbs_variables.temp_fw_out.item(),
            pressure=fwbs_variables.fwpressure.item(),
        )
        ...
        massrate = (
            ...
            * load
            / cfmean
            / (fwbs_variables.temp_fw_out - fwbs_variables.temp_fw_in)
        )
        ...
        temp_k = (fwbs_variables.temp_fw_out + fwbs_variables.tpeak) / 2  # (K)
        ...
        tpeakfw = fwbs_variables.temp_fw_out + deltat_solid + deltat_coolant
