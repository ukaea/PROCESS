    ...
    def sc_tf_internal_geom(self, i_tf_wp_geom, i_tf_case_geom, i_tf_turns_integer):
        ...
        if (
            ...
            logger.error(
                ...
                f"{sctfcoil_module.a_tf_coil_inboard_steel=} {sctfcoil_module.f_a_tf_coil_inboard_steel=}"
                f"{sctfcoil_module.a_tf_coil_inboard_insulation=} {sctfcoil_module.f_a_tf_coil_inboard_insulation=}"
            )
    ...
    def tf_integer_turn_geom(
        ...
        if sctfcoil_module.dr_tf_turn <= (
            ...
            logger.error(
                ...
                f"{sctfcoil_module.dr_tf_turn=} {dx_tf_turn_insulation=} {dx_tf_turn_steel=}"
            )
        ...
        if sctfcoil_module.dx_tf_turn <= (
            ...
            logger.error(
                "Negative cable space dimension; reduce conduit thicknesses or raise c_tf_turn. "
                f"{sctfcoil_module.dx_tf_turn=} {dx_tf_turn_insulation=} {dx_tf_turn_steel=}"
            )
        ...
        if a_tf_turn_cable_space_no_void <= 0.0e0:
            if (sctfcoil_module.dr_tf_turn_cable_space < 0.0e0) or (
                ...
                logger.error(
                    ...
                    f"{sctfcoil_module.dr_tf_turn_cable_space=} {sctfcoil_module.dx_tf_turn_cable_space=}"
                )
            else:
                logger.error(
                    "Cable space area problem; artificially set rounded corner radius to 0. "
                    f"{a_tf_turn_cable_space_no_void=} {sctfcoil_module.dr_tf_turn_cable_space=}"
                    f" {sctfcoil_module.dx_tf_turn_cable_space=}"
                )
