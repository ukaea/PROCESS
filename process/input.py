...
INPUT_VARIABLES = {
    ...
    "ifueltyp": InputVariable(fortran.cost_variables, int, choices=[0, 1, 2]),
    ...
    "cptdin": InputVariable(fortran.pfcoil_variables, float, array=True),
    "ipfloc": InputVariable(fortran.pfcoil_variables, int, array=True),
    "ncls": InputVariable(fortran.pfcoil_variables, int, array=True),
    "nfxfh": InputVariable(fortran.pfcoil_variables, int, array=True),
    "ngrp": InputVariable(
        fortran.pfcoil_variables, int, range=(0, fortran.pfcoil_variables.ngrpmx.item())
    ),
    "rref": InputVariable(fortran.pfcoil_variables, float, array=True),
    "vf": InputVariable(fortran.pfcoil_variables, float, array=True),
    "zref": InputVariable(fortran.pfcoil_variables, float, array=True),
    "uchts": InputVariable(fortran.cost_variables, float, array=True),
    "ucoam": InputVariable(fortran.cost_variables, float, array=True),
    "ucsc": InputVariable(fortran.cost_variables, float, array=True),
    "ucturb": InputVariable(fortran.cost_variables, float, array=True),
    "ucwst": InputVariable(fortran.cost_variables, float, array=True),
    ...
    "rjconpf": InputVariable(fortran.pfcoil_variables, float, array=True),
    "ixc": InputVariable(
        None,
        int,
