...
class Power:
    ...
    def tfpwcall(self, output: bool):
        ...
        e_tf_coil_magnetic_stored_mj = (
            tfcoil_variables.estotftgj / tfcoil_variables.n_tf_coils * 1.0e3
        )
    ...
    def tfcpwr(
        ...
        r1dump = nsptfc * vtfskv * N_TF_COIL_BREAKERS / itfka
        ...
        part2 = fspc2 * n_tf_breakers * (vtfskv * itfka) ** 0.667e0
