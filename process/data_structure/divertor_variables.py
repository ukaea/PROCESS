...
rad_div_outer_leg_plate_poloidal: float = None
...
z_div_inner_strike_point: float = None
"""vertical location of inner divertor strike point (m)"""

r_div_inner_plate_top: float = None
"""radial location of top of inner divertor plate (m)"""

z_div_inner_plate_top: float = None
"""vertical location of top of inner divertor plate (m)"""

r_div_inner_plate_bottom: float = None
"""radial location of bottom of inner divertor plate (m)"""
...
z_div_outer_strike_point: float = None
"""vertical location of outer divertor strike point (m)"""

r_div_outer_plate_top: float = None
"""radial location of top of outer divertor plate (m)"""

z_div_outer_plate_top: float = None
"""vertical location of top of outer divertor plate (m)"""
...
def init_divertor_variables():
    ...
    rad_div_outer_leg_plate_poloidal = 1.0
