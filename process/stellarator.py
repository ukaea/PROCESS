...
# NOTE: a different value of echarge was used in the original implementation
...
KEV = 1e3 * constants.echarge  # Kiloelectron-volt (keV)
...
class Neoclassics:
    ...
    def neoclassics_calc_nu(self):
        ...
        mass = np.array(
            [
                constants.emass,
                constants.mproton * 2.0,
                constants.mproton * 3.0,
                constants.mproton * 4.0,
            ]
        )
        z = np.array([-1.0, 1.0, 1.0, 2.0]) * constants.echarge
        ...
        lnlambda = (
            ...
            + 2.3 * np.log10(neoclassics_module.temperatures[0] / constants.echarge)
        )
    ...
    def neoclassics_calc_nu_star_fromT(self, iota):
        ...
        density = np.array(
            [
                physics_variables.dene,
                physics_variables.deni * physics_variables.fdeut,
                physics_variables.deni * (1 - physics_variables.fdeut),
                physics_variables.dnalp,
            ]
        )
        ...
        lnlambda = (
            ...
            + 2.3 * np.log10(temp[0] / constants.echarge)
        )
    ...
    def neoclassics_calc_vd(self):
        vde = (
            ...
            * neoclassics_module.temperatures[0]
            / (constants.echarge * physics_variables.rmajor * physics_variables.bt)
        )
        vdD = (
            neoclassics_module.roots
