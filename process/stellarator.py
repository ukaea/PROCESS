    ...
    def stfwbs(self, output: bool):
        ...
        if fwbs_variables.blktmodel == 0:
            if (fwbs_variables.blkttype == 1) or (
                ...
                fwbs_variables.m_blkt_total = (
                    fwbs_variables.wtblli2o + fwbs_variables.m_blkt_beryllium
                )
        ...
        if output:
            ...
            #             po.write(self.outfile,601) vol_blkt_inboard, vol_blkt_outboard, vol_blkt_total,                m_blkt_total, vfblkt, fbllipb, wtbllipb, fblli, whtblli,                fblss, m_blkt_steel_total, fblvd, whtblvd, volshldi, volshldo,                volshld, whtshld, vfshld, fwbs_variables.wpenshld
            #         else:  #  (also if ipowerflow=0)
            #             po.write(self.outfile,600) vol_blkt_inboard, vol_blkt_outboard, vol_blkt_total,                m_blkt_total, vfblkt, fblbe, m_blkt_beryllium, fblli2o, wtblli2o,                fblss, m_blkt_steel_total, fblvd, whtblvd, volshldi, volshldo,                volshld, whtshld, vfshld, fwbs_variables.wpenshld
