...
class Stellarator:
    ...
    def stfwbs(self, output: bool):
        ...
        if output:
            ...
            #             po.write(self.outfile,600) vol_blkt_inboard, vol_blkt_outboard, vol_blkt_total,                m_blkt_total, vfblkt, fblbe, whtblbe, fblli2o, wtblli2o,                fblss, m_blkt_steel_total, fblvd, whtblvd, volshldi, volshldo,                volshld, whtshld, vfshld, fwbs_variables.wpenshld
