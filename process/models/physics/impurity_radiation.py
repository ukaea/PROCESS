...
def calculate_average_charge_at_temp(imp_element_index, teprofile, data: DataStructure):
...
class ImpurityRadiation:
    ...
    def integrate_radiation_loss_profiles(self):
        ...
        """
        # 2.0e-6 converts from W/m³ to MW/m³ and also accounts for both sides of the
        # plasma
