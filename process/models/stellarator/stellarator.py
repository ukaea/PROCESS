...
class Stellarator:
    ...
    def st_fwbs(self, output: bool):
        ...
        #  When fwbs_variables.i_blanket_type == 1, although the blanket is by definition helium-cooled
        ...
        #  i_blkt_coolant_type=2 if fwbs_variables.i_blanket_type == 1; thus we can ignore the helium coolant mass
        #  in the blanket.
        ...
        #  N.B. for fwbs_variables.i_blanket_type == 1, mass of *water* coolant in the non-blanket
        ...
        if output:
            ...
            if (heat_transport_variables.ipowerflow == 0) and (
                fwbs_variables.i_blanket_type == 0
            ):
