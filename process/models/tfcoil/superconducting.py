...
class SuperconductingTFCoil(TFCoil):
    ...
    def superconducting_tf_wp_geometry(
        ...
        # ---------------------
            ...
            # superconducting_tf_coil_variables.r_tf_wp_inboard_centre [m]
    ...
    def run(self, output: bool = False):
        ...
        if (
            ...
            logger.error(
                ...
                f"{superconducting_tf_coil_variables.f_a_tf_coil_inboard_insulation=}"
            )
...
class CROCOSuperconductingTFCoil(SuperconductingTFCoil):
    ...
    def tf_croco_superconductor_properties(
        ...
        if output:  # Output ----------------------------------
            ...
            po.ovarre(
                self.outfile,
                "Critical current density in cable (A/m²)",
                "(j_crit_cable)",
                j_crit_cable,
                "OP ",
            )
            ...
            po.ovarre(
                self.outfile,
                "Actual current density in winding pack (A/m²)",
                "(jwdgop)",
                jwdgop,
                "OP ",
            )
