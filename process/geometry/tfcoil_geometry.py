...
def tfcoil_geometry_rectangular_shape(
    ...
    *,
    ...
    :type y5: float
    :param dr_tf_coil_inboard: inboard tf coil thickness
    :type dr_tf_coil_inboard: float
    ...
    return_rects.append(
        RectangleGeometry(
            anchor_x=x5 - dr_tf_coil_inboard + offset_in,
            anchor_z=y5 - dr_tf_coil_inboard,
            width=dr_tf_coil_inboard,
            height=(y1 - y5 + 2.0 * dr_tf_coil_inboard),
        )
    )
    ...
    return_rects.append(
        RectangleGeometry(
            ...
            anchor_z=y4 - dr_tf_coil_inboard,
            width=dr_tf_coil_inboard,
            height=(y2 - y4 + 2.0 * dr_tf_coil_inboard),
        )
    )
    # rectangle representing the lower horizontal part of the tf coil
    return_rects.append(
        RectangleGeometry(
            anchor_x=x5, anchor_z=y5 - dr_tf_coil_inboard + offset_in, width=x4 - x5, height=dr_tf_coil_inboard
        )
    )
    # rectangle representing the upper horizontal part of the tf coil
    return_rects.append(
        RectangleGeometry(
            anchor_x=x1, anchor_z=y1 - offset_in, width=(x2 - x1), height=dr_tf_coil_inboard
        )
    )
...
def tfcoil_geometry_d_shape(
    ...
    *,
    ...
    a1 = x2 - x1 - offset_in
    b1 = y2 - y1 - offset_in
    a2 = a1 + dr_tf_coil_inboard
    b2 = b1 + dr_tf_coil_inboard
    ...
    return_rects.append(
        RectangleGeometry(
            anchor_x=x5 - dr_tf_coil_inboard, anchor_z=y5, width=dr_tf_coil_inboard + offset_in, height=(y1 - y5)
        )
    )
