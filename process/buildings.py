...
class Buildings:
    ...
    def bldgs_sizes(self, output, tf_radial_dim, tf_vertical_dim):
        ...
        if cost_variables.life_plant_fpy != 0.0e0:
            hcomp_height = 2 * (
            ...
            hcomp_req_supply = (
                tfcoil_variables.n_tf_coils
                * (cost_variables.life_plant_fpy / cost_variables.life_plant_fpy)
        ...
        if cost_variables.life_div_fpy != 0.0e0:
            ...
            hcomp_req_supply = (
                tfcoil_variables.n_tf_coils
                * (cost_variables.life_plant_fpy / cost_variables.life_div_fpy)
            ) * buildings_variables.qnty_sfty_fac
        ...
        if cost_variables.cplife != 0.0e0:
            ...
            hcomp_req_supply = (
                cost_variables.life_plant_fpy / cost_variables.cplife
            ) * buildings_variables.qnty_sfty_fac
