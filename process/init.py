...
from process.data_structure.numerics import init_numerics
...
def check_process(inputs):  # noqa: ARG001
    ...
    if any(i == 0 for i in data_structure.numerics.ixc[: data_structure.numerics.nvar]):
        raise ProcessValidationError(
    ...
    if (
        13 in data_structure.numerics.ixc[: data_structure.numerics.nvar]
        and 140 in data_structure.numerics.ixc[: data_structure.numerics.nvar]
    ):
        raise ProcessValidationError(
    ...
    if any(
        i == 0
        for i in data_structure.numerics.icc[
    ...
    if (
        ...
        and data_structure.vacuum_variables.vacuum_model != "simple"
    ):
        raise ProcessValidationError(
    ...
    if any(
        i == 12 for i in data_structure.numerics.ixc[: data_structure.numerics.nvar]
    ):
        raise ProcessValidationError(
    ...
    if (
        ...
        if (
            ...
            and any(
                i == 4
                for i in data_structure.numerics.ixc[: data_structure.numerics.nvar]
            )
        ...
        if data_structure.physics_variables.fgwped < 0 or not any(
            i == 145
            for i in data_structure.numerics.ixc[: data_structure.numerics.nvar]
        ):
        ...
        if (
            data_structure.numerics.ioptimz >= 0
            and 81
            in data_structure.numerics.icc[
                : data_structure.numerics.neqns + data_structure.numerics.nineqns
            ]
        ):
            if 145 in data_structure.numerics.ixc[: data_structure.numerics.nvar]:
                warn(
                    "neped set with fgwped without constraint eq 81 (neped<ne0)",
                    stacklevel=2,
                )
            if 6 in data_structure.numerics.ixc[: data_structure.numerics.nvar]:
                warn(
    ...
    if (
        145 in data_structure.numerics.ixc[: data_structure.numerics.nvar]
        and data_structure.numerics.boundl[144]
    ...
    if (
        ...
        # iteration variable
        if 119 in data_structure.numerics.ixc[: data_structure.numerics.nvar]:
            raise ProcessValidationError(
        ...
        if (data_structure.physics_variables.i_l_h_threshold != 6) or (
            (
                15
                not in data_structure.numerics.icc[
                    : data_structure.numerics.neqns + data_structure.numerics.nineqns
                ]
            )
    ...
    if (
        (
            not (
                (16 in data_structure.numerics.ixc[: data_structure.numerics.nvar])
                or (29 in data_structure.numerics.ixc[: data_structure.numerics.nvar])
                or (42 in data_structure.numerics.ixc[: data_structure.numerics.nvar])
            )
    ...
    if 140 in data_structure.numerics.ixc[: data_structure.numerics.nvar]:
        ...
        if data_structure.tfcoil_variables.i_tf_sup == 1:
            ...
            if 58 in data_structure.numerics.ixc[: data_structure.numerics.nvar]:
    ...
    ) and data_structure.pfcoil_variables.i_cs_superconductor == 8:
        raise ProcessValidationError(
    ...
    ) and data_structure.tfcoil_variables.i_str_wp == 0:
