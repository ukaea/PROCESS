...
SCAN_VARIABLES = {
    ...
    22: ScanVariable("f_life_plant_available", "Plant_availability_factor"),
        ...
        match nwp:
            ...
            case 22:
                if cost_variables.i_plant_availability == 1:
                    raise ProcessValueError(
                        "Do not scan f_life_plant_available if i_plant_availability=1"
                    )
                cost_variables.f_life_plant_available = swp[iscn - 1]
            case 23:
