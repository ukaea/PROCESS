...
class CCFE_HCPB:
    ...
    def run(self, output: bool):
        ...
        # write(*,*)'p_fw_nuclear_heat_mw =', p_fw_nuclear_heat_mw, ' and ', 'pnucblkt =', pnucblkt
        ...
        # emultmw = p_fw_nuclear_heat_mw + pnucblkt + pnucshld + ptfnuc + pnucdiv - neutron_power_total
        # ---
