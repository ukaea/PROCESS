...
from process.models.physics.physics import DetailedPhysics
...
def main_plot(
    ...
    DetailedPhysics.plot_debye_length_profile(figs[17].add_subplot(232), m_file, scan)
    DetailedPhysics.plot_velocity_profile(figs[17].add_subplot(233), m_file, scan)
    ...
    DetailedPhysics.plot_ion_slowing_down_time_profile(
