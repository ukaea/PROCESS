...
def plot_main_plasma_information(
    ...
    textstr_fuelling = (
        ...
        f"Tritium burn-up rate: {mfile.get('fusrat_tritium_total_kg', scan=scan):.3e} kg/s \n"
...
def main_plot(
    ...
    TritiumPlantMeschini.plot_tritium_systems_overview(
        figs[29].add_subplot(111), m_file, scan, figs[29]
    )
